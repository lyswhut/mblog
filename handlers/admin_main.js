...
const BlogEdit = require('../viewModels/admin/blogEdit.js');
const Login = require('../viewModels/admin/login.js');
...
exports.get_logout = function(req, res, next) {
  req.session.destroy(function (err) {
    if (err) {
      log.error(err)
      return res.send(500, 'Error occurred: destroy session error.');
    }
